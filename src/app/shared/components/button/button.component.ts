...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      ...
      none: 'bg-transparent text-primary hover:bg-primary/10 focus-visible:ring-primary cursor-pointer',
    },
    danger: {
      bold: 'bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive cursor-pointer',
      light: 'bg-destructive/20 text-white hover:bg-destructive/30 focus-visible:ring-destructive cursor-pointer',
      none: 'bg-transparent text-white hover:bg-destructive/10 focus-visible:ring-destructive cursor-pointer',
    },
    success: {
      ...
      none: 'bg-transparent text-green-600 hover:bg-green-500/10 focus-visible:ring-green-500 cursor-pointer',
    },
    warning: {
      ...
      none: 'bg-transparent text-yellow-600 hover:bg-yellow-500/10 focus-visible:ring-yellow-500 cursor-pointer',
    },
    info: {
      ...
      none: 'bg-transparent text-violet-600 hover:bg-violet-500/10 focus-visible:ring-violet-500 cursor-pointer',
    },
    light: {
      bold: 'bg-muted text-muted-foreground hover:bg-muted/90 focus-visible:ring-muted cursor-pointer',
      light: 'bg-muted/20 text-muted-foreground hover:bg-muted focus-visible:ring-muted cursor-pointer',
      none: 'bg-transparent text-muted-foreground hover:bg-muted focus-visible:ring-muted cursor-pointer',
    },
  };
